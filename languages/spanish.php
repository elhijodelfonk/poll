...
return array(
	...
	'poll:group_poll' => "Encuesta de grupo",
	...
	'poll:addpost' => "Crear una encuesta",
	'poll:editpost' => "Editar la encuesta: %s",
	'poll:edit' => "Editar una encuesta",
	'item:object:poll' => 'Encuestas',
	'item:object:poll_choice' => "Opciones",
	'poll:question' => "Pregunta de la encuesta",
	'poll:description' => "Descripcion (opcional)",
	'poll:responses' => "Votos",
	'poll:result:label' => "%s (%s)",
	'poll:show_results' => "Mostrar resultados",
	'poll:show_poll' => "Mostrar encuesta",
	'poll:add_choice' => "Añadir opcion",
	'poll:delete_choice' => "Borrar esta opcion",
